...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            ...
            <!-- Tombol Tambah Bahan -->
            <a href="<?= base_url('produksi/persediaan/create'); ?>" class="btn btn-primary mb-3"><i class="fas fa-plus"></i> Tambah Bahan</a>
        </div>
        <!-- Tabel Daftar Bahan -->
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php if (empty($bahan)) : ?>
                            <tr>
                                <td colspan="7" class="text-center">Belum ada data bahan</td>
                            </tr>
                        <?php else : ?>
                            <?php $no = 1;
                            foreach ($bahan as $b) : ?>
